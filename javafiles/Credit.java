...
int credit=Integer.parseInt(req.getParameter("deposit"));

String a=String.valueOf(credit);
String am="-"+a;
String pm="+"+a;
...
RequestDispatcher dispp = req.getRequestDispatcher("credit.html");
	  dispp.include(req,res);
	  out.println("<html>");
	  out.println("<body onload='myFunction()'>");
	  out.println("<script>");
	  out.println("function myFunction(){alert('Amount Credited Successfuly !!');}");
	  out.println("</script>");
	  out.println("</body>");
	  out.println("</html>");	
